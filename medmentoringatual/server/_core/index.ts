...
async function startServer() {
  ...
  // Trust the first proxy (Manus reverse proxy) so req.protocol and req.ip
  ...
  // File upload route (before body parser for multipart)
  app.use(uploadRouter);
  // Import route for AI-powered data extraction
  app.use(importRouter);
  // PDF generation route for pillar conclusions
  app.use(pdfRouter);
  // Excel export routes
  app.use(excelRouter);
